...
// PARAMETERS:
LOCAL targApo TO 100000.
LOCAL window TO FALSE.

LOCAL lHead TO 61.4.
LOCAL lLAN TO 0.
LOCAL LTol TO 0.01.
LOCAL gTurnVel TO 30.
LOCAL gTurnPitch TO 60.
LOCAL gTurnTol TO 0.2.


// HELPER VARIABLES:
LOCAL pitchPID TO PIDLOOP(3, .5, 15, -20, 60).
...
LOCAL FUNCTION rs25Stage {
	RETURN STAGE:LIQUIDFUEL < 1.
}
LOCAL FUNCTION cryoStage {
	RETURN STAGE:OXIDIZER < 1.
}
