...
CLEARSCREEN.
UNTIL SHIP:OBT:VELOCITY:SURFACE:MAG < killSp {
	...
	LOCK THROTTLE TO ((-1*SHIP:VERTICALSPEED-holdSp) + 1) / ((SHIP:AVAILABLETHRUST / SHIP:MASS) / (SHIP:OBT:BODY:MU / (SHIP:ALTITUDE + SHIP:OBT:BODY:RADIUS)^2)).
}
